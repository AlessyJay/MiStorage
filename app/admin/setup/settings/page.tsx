              ...
              <DialogContent className="max-w-2xl border-none bg-slate-900">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-white">
                    Configure your storage facility&apos;s settings and
                    preferences.
                  </DialogDescription>
                </DialogHeader>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    Select your region&apos;s currency and date
                                    format.
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    Choose how unit dimensions will be
                                    displayed.
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                                ...
                                <FormItem className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>
                                          Allow customers to prepay for their
                                          storage units
                                        </p>
                                      </TooltipContent>
                                    </Tooltip>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    <FormLabel className="text-white">
                                      Disable partial payments for locked out
                                      customers
                                    </FormLabel>
                                    <Tooltip>
                                      <TooltipTrigger>
                                      ...
                                      <TooltipContent>
                                        <p>
                                          Prevent locked out customers from
                                ...
                                <FormItem className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>
                                          Allow the use of USB card swipers for
                                          payments
                                        </p>
                                      </TooltipContent>
                                    </Tooltip>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    Number of days required before the billing
                                    day
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                                  ...
                                  >
                                    ...
                                    <SelectContent>
                                      ...
                                      <SelectItem value="bill-first-prorate-now">
                                        Bill for first full month, prorate
                                        second month billed now.
                                      </SelectItem>
                                      ...
                                      <SelectItem value="prorate-bill-full">
                                        Prorate this month and bill full billing
                                        cycle starting next month.
                                      </SelectItem>
                                      <SelectItem value="prorate-bill-now">
                                        Prorate this month and bill now for the
                                        first billing cycle.
                                      </SelectItem>
                                    </SelectContent>
                                  </Select>
